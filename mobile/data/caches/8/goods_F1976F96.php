<?php exit;?>a:3:{s:8:"template";a:3:{i:0;s:61:"D:/phpStudy/WWW/xiaomi2015273/mobile/themes/miqinew/goods.dwt";i:1;s:72:"D:/phpStudy/WWW/xiaomi2015273/mobile/themes/miqinew/library/comments.lbi";i:2;s:75:"D:/phpStudy/WWW/xiaomi2015273/mobile/themes/miqinew/library/page_footer.lbi";}s:7:"expires";i:1515731058;s:8:"maketime";i:1515727458;}<!DOCTYPE html>
<html>
<head>
<meta name="Generator" content="ECSHOP v2.7.3" />
<meta content="text/html; charset=utf-8" http-equiv="Content-Type" />
<meta charset="utf-8" />
<title>小米头戴式耳机_小米头戴式耳机_耳机音箱与存储卡_小米官网——小米手机、红米手机、小米电视官方正品专卖网站 触屏版</title>
...
<header id="header">
  ...
  <h1> 商品详情 </h1>
  <div class="header_r header_search"> <a class="ico_15" href="ectouch.php?act=share&content=小米头戴式耳机&pic=images/201507/source_img/30_G_1437075007203.jpg"> 分享 </a> </div>
</header>
...
<section class="goods_slider">
  ...
  <div id="slideBox" class="slideBox">
    <div class="scroller"> 
      <!--<div><a href="javascript:showPic()"><img src="images/201507/thumb_img/30_thumb_G_1437075007558.jpg"  alt="小米头戴式耳机" /></a></div>-->
      <ul>
	  <li><a href="javascript:showPic()"><img alt="" src="http://localhost/images/201507/source_img/30_G_1437075007203.jpg"/></a></li>
         
         
        <li><a href="javascript:showPic()"><img alt="" src="http://localhost/images/201507/thumb_img/30_thumb_P_1437075007298.jpg"/></a></li>
         
        <li><a href="javascript:showPic()"><img alt="" src="http://localhost/images/201509/thumb_img/30_thumb_P_1441661907216.jpg"/></a></li>
         
        <li><a href="javascript:showPic()"><img alt="" src="http://localhost/images/201509/thumb_img/30_thumb_P_1441661907011.jpg"/></a></li>
         
        <li><a href="javascript:showPic()"><img alt="" src="http://localhost/images/201509/thumb_img/30_thumb_P_1441661908459.jpg"/></a></li>
...
<section class="goodsInfo">
  <a class="collect" id="collect_box" href="javascript:collect(30)" style="display: inline;"></a>
  <div class="title">
    <h1> 小米头戴式耳机 </h1>
  </div>
    <div class="title">
  ...
  <ul>
        <li>本店售价：<b class="price">499<em>元</em></b>　    <del>598<em>元</em></del> 
    </li>
    ...
    <form action="javascript:addToCart(30)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
     <div class="fields"   style="display: block;">	 
        ...
        <ul class="ul2">
          ...
          <h2>颜色：</h2>
            <div class="items">
                            				                                          ...
                            				                                          <input type="radio" name="spec_12" value="85" id="spec_value_85" checked onclick="changePrice()" />
                    <label for="spec_value_85">白-<font class="price">缺货</font></label> 
                                        <input type="radio" name="spec_12" value="86" id="spec_value_86"  onclick="changePrice()" />
                    <label for="spec_value_86">蓝-<font class="price">缺货</font></label> 
                                        <input type="radio" name="spec_12" value="87" id="spec_value_87"  onclick="changePrice()" />
                    <label for="spec_value_87">红-<font class="price">缺货</font></label> 
      ...
      <div class="option" > 
        ...
        <button type="button" class="btn buy radius5" onClick="addToCart_quick(30)">立即购买</button>
        <button type="button" class="btn cart radius5" onclick="addToCart(30);">
        ...
        <div class="popGeneral" id="popDiv" >
          ...
          <div id="main">
            <div id="left"> <img width="115" height="115" src="http://localhost/images/201507/source_img/30_G_1437075007203.jpg"> </div>
            <div id="right">
              <p>小米头戴式耳机</p>
...
<p><img src="/xiaomi2015273/images/upload/Image/mhyte110940.png" width="854" height="836" alt="" /></p>	      </div>
  ...
  <div id="tab2" class="hidden">
    <div class="wrap">
      <div class="blank2"></div>
      <script type="text/javascript" src="data/static/js/transport.js"></script><script type="text/javascript" src="data/static/js/utils.js"></script><div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:30;}554fcae493e564ee0dc75bdf2ebf94ca</div>
 </div>
  </div>
...
var end = "结束";
var goodsId = 30;
var now_time = 1515727458;
var imgUrl = "http://localhost/images/201507/source_img/30_G_1437075007203.jpg"; //缩略图地址
var lineLink = ""; //分享的链接地址
var descContent = "小米头戴式耳机_小米头戴式耳机_耳机音箱与存储卡_小米官网——小米手机、红米手机、小米电视官方正品专卖网站"; //摘要信息
var shareTitle = "小米头戴式耳机_小米头戴式耳机_耳机音箱与存储卡_小米官网——小米手机、红米手机、小米电视官方正品专卖网站"; //分享的标题
var appid = ""; 
//分享给朋友
