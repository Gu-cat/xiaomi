<?php exit;?>a:3:{s:8:"template";a:3:{i:0;s:61:"D:/phpStudy/WWW/xiaomi2015273/mobile/themes/miqinew/goods.dwt";i:1;s:72:"D:/phpStudy/WWW/xiaomi2015273/mobile/themes/miqinew/library/comments.lbi";i:2;s:75:"D:/phpStudy/WWW/xiaomi2015273/mobile/themes/miqinew/library/page_footer.lbi";}s:7:"expires";i:1515635764;s:8:"maketime";i:1515632164;}<!DOCTYPE html>
<html>
<head>
<meta name="Generator" content="ECSHOP v2.7.3" />
<meta content="text/html; charset=utf-8" http-equiv="Content-Type" />
<meta charset="utf-8" />
<title>小米活塞耳机 炫彩版_小米活塞耳机_耳机音箱与存储卡_小米官网——小米手机、红米手机、小米电视官方正品专卖网站 触屏版</title>
...
<header id="header">
  ...
  <h1> 商品详情 </h1>
  <div class="header_r header_search"> <a class="ico_15" href="ectouch.php?act=share&content=小米活塞耳机 炫彩版&pic=images/201507/source_img/38_G_1437082667365.jpg"> 分享 </a> </div>
</header>
...
<section class="goods_slider">
  ...
  <div id="slideBox" class="slideBox">
    <div class="scroller"> 
      <!--<div><a href="javascript:showPic()"><img src="images/201507/thumb_img/38_thumb_G_1437082667838.jpg"  alt="小米活塞耳机 炫彩版" /></a></div>-->
      <ul>
	  <li><a href="javascript:showPic()"><img alt="" src="http://localhost/images/201507/source_img/38_G_1437082667365.jpg"/></a></li>
         
         
        <li><a href="javascript:showPic()"><img alt="" src="http://localhost/images/201507/thumb_img/38_thumb_P_1437082667724.jpg"/></a></li>
         
        <li><a href="javascript:showPic()"><img alt="" src="http://localhost/images/201509/thumb_img/38_thumb_P_1442179091550.jpg"/></a></li>
         
        <li><a href="javascript:showPic()"><img alt="" src="http://localhost/images/201509/thumb_img/38_thumb_P_1442179091581.jpg"/></a></li>
         
        <li><a href="javascript:showPic()"><img alt="" src="http://localhost/images/201509/thumb_img/38_thumb_P_1442179091766.jpg"/></a></li>
...
<section class="goodsInfo">
  <a class="collect" id="collect_box" href="javascript:collect(38)" style="display: inline;"></a>
  <div class="title">
    <h1> 小米活塞耳机 炫彩版 </h1>
  </div>
    <div class="title">
  ...
  <ul>
        <li>本店售价：<b class="price">39<em>元</em></b>　    <del>47<em>元</em></del> 
    </li>
    ...
    <li>
        ...
        <a href="group_buy.php?act=view&amp;id=23" title="团购活动 小米活塞耳机 炫彩版的时间为2015-09-13到2019-09-13，赶快来抢吧！" class="rule c333">小米活塞耳机 炫彩版</a><br />
        </li>
  </ul>
...
<div class="wrap">
  <section class="goodsBuy radius5">
    ...
    <div>请选择<span>颜色/线长</span><i></i></div>
     ...
     <div class="fields"   style="display: block;">	 
        ...
        <ul class="ul2">
          ...
          <h2>颜色：</h2>
            <div class="items">
                            				                                          ...
                            				                                          <input type="radio" name="spec_12" value="89" id="spec_value_89" checked onclick="changePrice()" />
                    <label for="spec_value_89">丁香紫-<font class="price">缺货</font></label> 
                                        <input type="radio" name="spec_12" value="90" id="spec_value_90"  onclick="changePrice()" />
                    <label for="spec_value_90">冰川蓝-<font class="price">缺货</font></label> 
                                        <input type="radio" name="spec_12" value="91" id="spec_value_91"  onclick="changePrice()" />
                    <label for="spec_value_91">樱花粉-<font class="price">缺货</font></label> 
          ...
          <h2>线长：</h2>
            <div class="items">
                            				  										...
                            				  										<input type="radio" name="spec_13" value="92" id="spec_value_92" checked onclick="changePrice()" />
                    <label for="spec_value_92">50cm</label> 
        ...
        <ul class="quantity">
          ...
          <div class="items"> <span class="ui-number radius5"> 
            ...
            <input class="num" name="number" id="goods_number" autocomplete="off" value="1" min="1" max="9998" type="number" />
      ...
      <div class="option" > 
        ...
        <button type="button" class="btn buy radius5" onClick="addToCart_quick(38)">立即购买</button>
        <button type="button" class="btn cart radius5" onclick="addToCart(38);">
        ...
        <div class="popGeneral" id="popDiv" >
          ...
          <div id="main">
            <div id="left"> <img width="115" height="115" src="http://localhost/images/201507/source_img/38_G_1437082667365.jpg"> </div>
            <div id="right">
              <p>小米活塞耳机 炫彩版</p>
...
<section class="s-detail">
  <header>
    <ul style="position: static;" id="detail_nav">
      ...
      <li id="tabs2" onClick="tab(2)" class=""> 评价 <span class="review-count">(7)</span> </li>
  ...
  <div id="tab1" class="">
    <div class="desc wrap">
      <div class="blank2"></div>
	  		...
	  		<p><img width="1226" height="691" alt="" src="/xiaomi2015273/images/upload/Image/xhsejxcb_01x.jpg" /></p>
...
<p><img width="1226" height="692" alt="" src="/xiaomi2015273/images/upload/Image/xhsejxcb_37.jpg" /></p>	      </div>
  </div>
  <div id="tab2" class="hidden">
    <div class="wrap">
      <div class="blank2"></div>
      <script type="text/javascript" src="data/static/js/transport.js"></script><script type="text/javascript" src="data/static/js/utils.js"></script><div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:38;}554fcae493e564ee0dc75bdf2ebf94ca</div> </div>
  </div>
...
var end = "结束";
var goodsId = 38;
var now_time = 1515632164;
var imgUrl = "http://localhost/images/201507/source_img/38_G_1437082667365.jpg"; //缩略图地址
var lineLink = ""; //分享的链接地址
var descContent = "小米活塞耳机 炫彩版_小米活塞耳机_耳机音箱与存储卡_小米官网——小米手机、红米手机、小米电视官方正品专卖网站"; //摘要信息
var shareTitle = "小米活塞耳机 炫彩版_小米活塞耳机_耳机音箱与存储卡_小米官网——小米手机、红米手机、小米电视官方正品专卖网站"; //分享的标题
var appid = ""; 
//分享给朋友
