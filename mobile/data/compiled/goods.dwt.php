...
var imgUrl = "<?php echo $this->_var['site_url']; ?><?php echo $this->_var['goods']['original_img']; ?>"; //缩略图地址
var lineLink = "<?php echo $this->_var['userurl']; ?>"; //分享的链接地址
var descContent = "<?php echo $this->_var['page_title']; ?>"; //摘要信息
var shareTitle = "<?php echo $this->_var['page_title']; ?>"; //分享的标题
var appid = "<?php echo $this->_var['appid']; ?>"; 
...
//分享给朋友
		function shareFriend() {
    		WeixinJSBridge.invoke('sendAppMessage',{
        		...
        		window.location.href = '<?php if ($this->_var['dourl']): ?><?php echo $this->_var['dourl']; ?>&type=1<?php endif; ?>';
    		})
		}
		//分享到朋友圈
		function shareTimeline() {
    		WeixinJSBridge.invoke('shareTimeline',{
        		...
        		window.location.href = '<?php if ($this->_var['dourl']): ?><?php echo $this->_var['dourl']; ?>&type=2<?php endif; ?>';
    		});
		}
		//分享到企鹅微博
		function shareWeibo() {
