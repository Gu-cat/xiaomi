...
<form method="post" action="privilege.php" name='theForm' onsubmit="return validate()">
  <table cellspacing="0" cellpadding="0" style="width:521px; height:327px;background:url(images/loginbg.png); color:#727272; font-size:#727272; margin:auto; margin-top:212px;" align="center">
    ...
    <tr>
      ...
      <tr>
        <td  width="131"><?php echo $this->_var['lang']['label_captcha']; ?></td>
        <td><input type="text" name="captcha" class="capital"  style=" width:216px; height:24px; padding:0; line-height:24px; background:url(images/txtbg.png) no-repeat; border:none; padding:0px 3px;"  /></td>
      </tr>
      <tr>
      <td  width="131">&nbsp;&nbsp;&nbsp;</td>
      <td colspan="2" align="center"><img src="index.php?act=captcha&<?php echo $this->_var['random']; ?>" width="" height="" alt="CAPTCHA" border="1" onclick= this.src="index.php?act=captcha&"+Math.random() style="cursor: pointer;" title="<?php echo $this->_var['lang']['click_for_another']; ?>" />
      </td>
      </tr>
      <?php endif; ?>
