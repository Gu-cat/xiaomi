...
<div id="main" class="layout">
  <div class="nl-content">
  	<div class="nl-logo-area">
    	<a href="./"><img src="themes/xiaomi/images/logo.gif" width="55" /></a>
    </div>
    <h1 class="nl-login-title">一个帐号，玩转所有<?php echo $this->_var['shop_name']; ?>服务！</h1>
    ...
    <div id="login-box" class="nl-frame-container">
        <div class="ng-form-area show-place">
            <form name="formLogin" action="user.php" method="post" onSubmit="return userLogin()">
                ...
                <a class="button" href="user.php?act=register">注册<?php echo $this->_var['shop_name']; ?>账号</a>
            </form>
        </div>
    </div>
  </div>
              ...
              <input type="hidden" id="sendtype">
                ...
                <div class="inputbg"> 
                  <label class="labelbox">
                      <input type="text" name="username" id="username" onblur="is_registered(this.value);" onkeyup="is_registered(this.value);" placeholder="<?php echo $this->_var['lang']['label_username']; ?>">
                  </label>
                ...
                <div class="inputbg"> 
                  <label class="labelbox">
                      <input name="email" type="text" id="email" onblur="checkEmail(this.value);" onkeyup="checkEmail(this.value);" placeholder="<?php echo $this->_var['lang']['label_email']; ?>">
                  </label>
