...
?> 
          <li <?php if ($this->_var['key'] == 1): ?>class="on"<?php endif; ?>><a href="javascript:;">套餐<span class="icon_step"><?php echo $this->_var['comboTab'][$this->_var['key']]; ?></span></a>
          </li>
...
?> 
            ...
            <li class="price_info submit_<?php echo $this->_var['key']; ?>">
              ...
              <p class="buy"><a href="javascript:addMultiToCart('m_goods_<?php echo $this->_var['key']; ?>', '<?php echo $this->_var['goods']['goods_id']; ?>')" class="btn btn-primary">购买套餐</a></p>
