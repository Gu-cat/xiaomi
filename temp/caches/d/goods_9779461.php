<?php exit;?>a:3:{s:8:"template";a:9:{i:0;s:42:"D:/phpStudy/WWW/mi/themes/xiaomi/goods.dwt";i:1;s:56:"D:/phpStudy/WWW/mi/themes/xiaomi/library/page_header.lbi";i:2;s:58:"D:/phpStudy/WWW/mi/themes/xiaomi/library/ur_here_goods.lbi";i:3;s:58:"D:/phpStudy/WWW/mi/themes/xiaomi/library/goods_gallery.lbi";i:4;s:52:"D:/phpStudy/WWW/mi/themes/xiaomi/library/history.lbi";i:5;s:59:"D:/phpStudy/WWW/mi/themes/xiaomi/library/goods_fittings.lbi";i:6;s:53:"D:/phpStudy/WWW/mi/themes/xiaomi/library/comments.lbi";i:7;s:56:"D:/phpStudy/WWW/mi/themes/xiaomi/library/page_footer.lbi";i:8;s:49:"D:/phpStudy/WWW/mi/themes/xiaomi/library/help.lbi";}s:7:"expires";i:1515033121;s:8:"maketime";i:1515029521;}<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<title>小米NOTE_小米Note_购买手机_小米官网——小米手机、红米手机、小米电视官方正品专卖网站 - Powered by ECShop</title>
                	...
                	<a class="link" href="category.php?id=76"  ><span>购买电视与平板</span></a>
                    	...
                    	<div class="container">
                        	<ul class="children-list clearfix">
                            	...
                            	<li class="nav-item">
                	<a class="link" href="category.php?id=69"   class="current"><span>购买手机</span></a>
                                        <div class='item-children'>
                    	<div class="container">
                        	<ul class="children-list clearfix">
                            	                                                                                                                                                <li class="first">
...
<script type="text/javascript" src="js/magiczoomplus.js"></script><script type="text/javascript" src="js/easydialog.min.js"></script><script type="text/javascript" src="js/xiaomi_goods.js"></script><div class="breadcrumbs">
	<div class="container">
    	<a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=69">购买手机</a> <code>&gt;</code> <a href="category.php?id=70">小米Note</a> <code>&gt;</code> 小米NOTE         
    </div>
</div> 
<div class="goods-detail">
  ...
  <div class="goods-big-pic"> 
  	<a href="images/201509/goods_img/80_P_1441050558370.png" class="MagicZoomPlus" id="Zoomer" rel="hint-text: ; selectors-effect: false; selectors-class: current; zoom-distance: 60;zoom-width: 400; zoom-height: 400;" > 
    	<img  alt="小米NOTE" src="images/201509/goods_img/80_P_1441050558370.png"> 
    </a> 
  </div>
  <div class="goods-small-pic" id="item-thumbs">
  	...
  	<div class="bd">
    	<ul class="cle">
                    ...
                    <li class="current"> 
          	<a href="images/201509/goods_img/80_P_1441050558370.png" rel="zoom-id: Zoomer" rev="images/201509/goods_img/80_P_1441050558370.png"> 
            	<img alt="小米NOTE" src="images/201509/thumb_img/80_thumb_P_1441050558679.jpg"> 
            </a>
          </li>
          ...
          <form action="javascript:addToCart(80)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
            ...
            <div class="goods-info-box" id="item-info">
              <dl class="loaded">
              	<dt class="goods-info-head">
                	<dl>
                    	<dt class="goods-name">小米NOTE</dt>
                        <dd class="goods-phone-type"><p></p></dd>
                                                <del>专柜价： <em class="cancel">2639<em>元</em></em></del>
                                                <dd class="goods-info-head-price clearfix">
                               
                              <span>本店价：</span> <span class="unit"> <b class="nala_price red" id="ECS_SHOPPRICE">2199<em>元</em> </b> </span>  
                        ...
                        <dd>
                            ...
                            <ul>
                                                            ...
                                                            <li> <span class="lbl">商品货号</span> <em>ECS000080</em> </li>
                                                            ...
                                                            <li><span>此商品可使用：<em class="red">2100</em>积分</span></li>
                        ...
                        <dd class="goods-info-head-cart">
                          <a href="javascript:addToCart(80)" class="btn  btn-primary goods-add-cart-btn" id="buy_btn"><i class="iconfont"></i>加入购物车</a>
                          <a href="javascript:collect(80)" class=" btn btn-gray  goods-collect-btn " id="fav-btn"><i class="iconfont"></i>喜欢</a> 
                        </dd>
...
$(function(){
	...
	$('.m_goods_body').click(function(){
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), 80); //基本件(组,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), 80); //删除基本件(组,主件)
	...
	$('.m_goods_list').click(function(){
		...
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), $(this).val(),80); //新增配件(组,配件,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), $(this).val(),80); //删除基本件(组,配件,主件)
			display_Price($(this).attr('item'),$(this).attr('item').charAt($(this).attr('item').length-1));
		}
	})
	//可以购买套餐的最大数量
  ...
  <div class="goods-detail-main">
    ...
    <div class="product_tabs">
      ...
      <div class="goods-detail-param">
          <div class="container">
          	<ul class="param-list">
            	<li class="goods-img"><img src="images/201509/thumb_img/80_thumb_P_1441050558679.jpg" alt="小米NOTE" /></li>
...
554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:80;}554fcae493e564ee0dc75bdf2ebf94ca        </div>
	  </div>
    </div>
...
<div class="goods-sub-bar" id="goodsSubBar">
	<div class="container">
        ...
        <dl class="goods-sub-bar-info clearfix">
        	<dt><img src="images/201509/thumb_img/80_thumb_P_1441050558679.jpg" alt="小米NOTE" /></dt>
            <dd>
            	<strong>小米NOTE</strong>
                <p><em></em></p>
            </dd>
        </dl>
        <a href="javascript:addToCart(80)" class="btn btn-primary goods-add-cart-btn"><i class="iconfont"></i> 加入购物车</a>
    </div>
</div>
