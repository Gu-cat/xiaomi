<?php exit;?>a:3:{s:8:"template";a:9:{i:0;s:53:"D:/phpStudy/WWW/xiaomi2015273/themes/xiaomi/goods.dwt";i:1;s:67:"D:/phpStudy/WWW/xiaomi2015273/themes/xiaomi/library/page_header.lbi";i:2;s:69:"D:/phpStudy/WWW/xiaomi2015273/themes/xiaomi/library/ur_here_goods.lbi";i:3;s:69:"D:/phpStudy/WWW/xiaomi2015273/themes/xiaomi/library/goods_gallery.lbi";i:4;s:63:"D:/phpStudy/WWW/xiaomi2015273/themes/xiaomi/library/history.lbi";i:5;s:70:"D:/phpStudy/WWW/xiaomi2015273/themes/xiaomi/library/goods_fittings.lbi";i:6;s:64:"D:/phpStudy/WWW/xiaomi2015273/themes/xiaomi/library/comments.lbi";i:7;s:67:"D:/phpStudy/WWW/xiaomi2015273/themes/xiaomi/library/page_footer.lbi";i:8;s:60:"D:/phpStudy/WWW/xiaomi2015273/themes/xiaomi/library/help.lbi";}s:7:"expires";i:1515570642;s:8:"maketime";i:1515567042;}<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta name="Generator" content="ECSHOP v2.7.3" />
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="Keywords" content="" />
<meta name="Description" content="主流双频AC智能路由器，性价比之王" />
<title>小米路由器 mini_小米路由器mini_路由器与智能硬件_小米官网——小米手机、红米手机、小米电视官方正品专卖网站 - Powered by ECShop</title>
...
<script type="text/javascript" src="js/magiczoomplus.js"></script><script type="text/javascript" src="js/easydialog.min.js"></script><script type="text/javascript" src="js/xiaomi_goods.js"></script><div class="breadcrumbs">
	<div class="container">
    	<a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=80">路由器与智能硬件</a> <code>&gt;</code> <a href="category.php?id=82">小米路由器mini</a> <code>&gt;</code> 小米路由器 mini         
    </div>
</div>
...
<div class="goods-detail">
  ...
  <div class="goods-big-pic"> 
  	<a href="images/201507/goods_img/32_P_1437075765944.jpg" class="MagicZoomPlus" id="Zoomer" rel="hint-text: ; selectors-effect: false; selectors-class: current; zoom-distance: 60;zoom-width: 400; zoom-height: 400;" > 
    	<img  alt="小米路由器 mini" src="images/201507/goods_img/32_P_1437075765944.jpg"> 
    </a> 
  </div>
  <div class="goods-small-pic" id="item-thumbs">
  	...
  	<div class="bd">
    	<ul class="cle">
                    ...
                    <li class="current"> 
          	<a href="images/201507/goods_img/32_P_1437075765944.jpg" rel="zoom-id: Zoomer" rev="images/201507/goods_img/32_P_1437075765944.jpg"> 
            	<img alt="小米路由器 mini" src="images/201507/thumb_img/32_thumb_P_1437075765465.jpg"> 
            </a>
          </li>
            ...
            <div class="goods-info-box" id="item-info">
              <dl class="loaded">
              	<dt class="goods-info-head">
                	<dl>
                    	<dt class="goods-name">小米路由器 mini</dt>
                        <dd class="goods-phone-type"><p>主流双频AC智能路由器，性价比之王</p></dd>
                                                <del>专柜价： <em class="cancel">154<em>元</em></em></del>
                                                <dd class="goods-info-head-price clearfix">
                               
                              <span>本店价：</span> <span class="unit"> <b class="nala_price red" id="ECS_SHOPPRICE">129<em>元</em> </b> </span>  
                        ...
                        <dd>
                            ...
                            <ul>
                                                            ...
                                                            <li> <span class="lbl">商品货号</span> <em>ECS000032</em> </li>
                                                            ...
                                                            <li><span>此商品可使用：<em class="red">100</em>积分</span></li>
                        ...
                        <dd class="goods-info-head-cart">
                          <a href="javascript:addToCart(32)" class="btn  btn-primary goods-add-cart-btn" id="buy_btn"><i class="iconfont"></i>加入购物车</a>
                          <a href="javascript:collect(32)" class=" btn btn-gray  goods-collect-btn " id="fav-btn"><i class="iconfont"></i>喜欢</a> 
                        </dd>
...
$(function(){
	...
	$('.m_goods_body').click(function(){
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), 32); //基本件(组,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), 32); //删除基本件(组,主件)
	...
	$('.m_goods_list').click(function(){
		...
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), $(this).val(),32); //新增配件(组,配件,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), $(this).val(),32); //删除基本件(组,配件,主件)
			display_Price($(this).attr('item'),$(this).attr('item').charAt($(this).attr('item').length-1));
		}
	})
	//可以购买套餐的最大数量
  ...
  <div class="goods-detail-main">
    ...
    <div class="product_tabs">
      ...
      <div class="goods-detail-param">
          <div class="container">
          	<ul class="param-list">
            	<li class="goods-img"><img src="images/201507/thumb_img/32_thumb_P_1437075765465.jpg" alt="小米路由器 mini" /></li>
                <li class="goods-tech-spec">
                	<ul>
                        <li>产品名称：小米路由器 mini</li>
...
554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:32;}554fcae493e564ee0dc75bdf2ebf94ca        </div>
	  </div>
    </div>
...
<div class="goods-sub-bar" id="goodsSubBar">
	<div class="container">
        ...
        <dl class="goods-sub-bar-info clearfix">
        	<dt><img src="images/201507/thumb_img/32_thumb_P_1437075765465.jpg" alt="小米路由器 mini" /></dt>
            <dd>
            	<strong>小米路由器 mini</strong>
                <p><em>主流双频AC智能路由器，性价比之王</em></p>
            </dd>
        </dl>
        <a href="javascript:addToCart(32)" class="btn btn-primary goods-add-cart-btn"><i class="iconfont"></i> 加入购物车</a>
    </div>
</div>
