<?php exit;?>a:3:{s:8:"template";a:9:{i:0;s:46:"D:/phpStudy/WWW/xiaomi/themes/xiaomi/goods.dwt";i:1;s:60:"D:/phpStudy/WWW/xiaomi/themes/xiaomi/library/page_header.lbi";i:2;s:62:"D:/phpStudy/WWW/xiaomi/themes/xiaomi/library/ur_here_goods.lbi";i:3;s:62:"D:/phpStudy/WWW/xiaomi/themes/xiaomi/library/goods_gallery.lbi";i:4;s:56:"D:/phpStudy/WWW/xiaomi/themes/xiaomi/library/history.lbi";i:5;s:63:"D:/phpStudy/WWW/xiaomi/themes/xiaomi/library/goods_fittings.lbi";i:6;s:57:"D:/phpStudy/WWW/xiaomi/themes/xiaomi/library/comments.lbi";i:7;s:60:"D:/phpStudy/WWW/xiaomi/themes/xiaomi/library/page_footer.lbi";i:8;s:53:"D:/phpStudy/WWW/xiaomi/themes/xiaomi/library/help.lbi";}s:7:"expires";i:1515570428;s:8:"maketime";i:1515566828;}<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<title>小米手环_小米手环_路由器与智能硬件_小米官网——小米手机、红米手机、小米电视官方正品专卖网站 - Powered by ECShop</title>
...
<script type="text/javascript" src="js/magiczoomplus.js"></script><script type="text/javascript" src="js/easydialog.min.js"></script><script type="text/javascript" src="js/xiaomi_goods.js"></script><div class="breadcrumbs">
	<div class="container">
    	<a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=80">路由器与智能硬件</a> <code>&gt;</code> <a href="category.php?id=83">小米手环</a> <code>&gt;</code> 小米手环         
    </div>
</div>
...
<div class="goods-detail">
  ...
  <div class="goods-big-pic"> 
  	<a href="images/201508/goods_img/67_P_1440983638515.png" class="MagicZoomPlus" id="Zoomer" rel="hint-text: ; selectors-effect: false; selectors-class: current; zoom-distance: 60;zoom-width: 400; zoom-height: 400;" > 
    	<img  alt="小米手环" src="images/201508/goods_img/67_P_1440983638515.png"> 
    </a> 
  </div>
  <div class="goods-small-pic" id="item-thumbs">
  	...
  	<div class="bd">
    	<ul class="cle">
                    ...
                    <li class="current"> 
          	<a href="images/201508/goods_img/67_P_1440983638515.png" rel="zoom-id: Zoomer" rev="images/201508/goods_img/67_P_1440983638515.png"> 
            	<img alt="小米手环" src="images/201508/thumb_img/67_thumb_P_1440983638347.jpg"> 
            </a>
          </li>
            ...
            <div class="goods-info-box" id="item-info">
              <dl class="loaded">
              	<dt class="goods-info-head">
                	<dl>
                    	<dt class="goods-name">小米手环</dt>
                        <dd class="goods-phone-type"><p></p></dd>
                                                <del>专柜价： <em class="cancel">83<em>元</em></em></del>
                                                <dd class="goods-info-head-price clearfix">
                               
                              <span>本店价：</span> <span class="unit"> <b class="nala_price red" id="ECS_SHOPPRICE">69<em>元</em> </b> </span>  
                        ...
                        <dd>
                            ...
                            <ul>
                                                            ...
                                                            <li> <span class="lbl">商品货号</span> <em>ECS000067</em> </li>
                                                            ...
                                                            <li> <span class="lbl">上架时间：</span> <em>2015-08-31</em> </li>
                        ...
                        <dd class="goods-info-head-cart">
                          <a href="javascript:addToCart(67)" class="btn  btn-primary goods-add-cart-btn" id="buy_btn"><i class="iconfont"></i>加入购物车</a>
                          <a href="javascript:collect(67)" class=" btn btn-gray  goods-collect-btn " id="fav-btn"><i class="iconfont"></i>喜欢</a> 
                        </dd>
...
$(function(){
	...
	$('.m_goods_body').click(function(){
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), 67); //基本件(组,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), 67); //删除基本件(组,主件)
	...
	$('.m_goods_list').click(function(){
		...
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), $(this).val(),67); //新增配件(组,配件,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), $(this).val(),67); //删除基本件(组,配件,主件)
			display_Price($(this).attr('item'),$(this).attr('item').charAt($(this).attr('item').length-1));
		}
	})
	//可以购买套餐的最大数量
  ...
  <div class="goods-detail-main">
    ...
    <div class="product_tabs">
      ...
      <div class="goods-detail-param">
          <div class="container">
          	<ul class="param-list">
            	<li class="goods-img"><img src="images/201508/thumb_img/67_thumb_P_1440983638347.jpg" alt="小米手环" /></li>
...
554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:67;}554fcae493e564ee0dc75bdf2ebf94ca        </div>
	  </div>
    </div>
...
<div class="goods-sub-bar" id="goodsSubBar">
	<div class="container">
        ...
        <dl class="goods-sub-bar-info clearfix">
        	<dt><img src="images/201508/thumb_img/67_thumb_P_1440983638347.jpg" alt="小米手环" /></dt>
            <dd>
            	<strong>小米手环</strong>
                <p><em></em></p>
            </dd>
        </dl>
        <a href="javascript:addToCart(67)" class="btn btn-primary goods-add-cart-btn"><i class="iconfont"></i> 加入购物车</a>
    </div>
</div>
